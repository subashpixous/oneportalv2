...
namespace Utils
{
    public static class StringFunctions
    {
        ...
        public static async Task<string> GetBase64FromUrlAsync(string fileUrl)
        {
            try
            {
        ...
        public static bool IsValidUrl(string url)
        {
            ...
            // Try to create a Uri instance and check if it has a valid scheme (http or https)
        ...
        public static string GetLastCodeSegment(string input)
        {
        ...
        public static PropertyInfo[] GetPropertiesWithAttribute<T, TAttribute>()
        where TAttribute : Attribute
        {
            var properties = typeof(T).GetProperties();

            var propertiesWithAttribute = properties
                .Where(property => Attribute.IsDefined(property, typeof(TAttribute)))
                .ToArray();

            return propertiesWithAttribute;
        }
        public static double ConvertRupeesToCrores(double rupees)
        {
            const double CroreConversionFactor = 0.01; // 1 Crore = 100 Lakhs = 100,00,000

            // Convert rupees to crores
            double crores = rupees * CroreConversionFactor;
            //return crores;
            return Math.Round(crores, 2);
        }

        public static List<string> GenerateFinancialYearSeries(int startYear, int endYear)
        {
        ...
        public static DateTime DateTimeToIST(DateTime dateTime)
        {
